...
DROP TABLE IF EXISTS patient_encounter_icd9;

-- create patient_encounter_icd9 table:
CREATE TABLE patient_encounter_icd9 (
	patient_nbr	BIGINT,
	encounter_id BIGINT,
	admission_type_id INTEGER,
	admission_source_id	INTEGER,
	...
	number_inpatient INTEGER,
	diag_1 VARCHAR(8),
	diag_1_desc VARCHAR(255),
	diag_2 VARCHAR(8),
	diag_2_desc VARCHAR(255),
	diag_3 VARCHAR(8),
	diag_3_desc VARCHAR(255),
	number_diagnoses INTEGER,
    max_glu_serum VARCHAR(10),
	a1cresult VARCHAR(10),
	metformin VARCHAR(10),
