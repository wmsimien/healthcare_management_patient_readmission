...
-- insert inot bronze_admission_type based on data from Excel IDS_mapping file
...
(' Transfer from a Skilled Nursing Facility (SNF)'), (' Transfer from another health care facility'),
...
(' Sick Baby'), (' Extramural Birth'), ('Not Available'), (NULL),(NULL), (' Transfer From Another Home Health Agency'),
